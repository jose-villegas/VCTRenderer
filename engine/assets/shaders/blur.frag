...
// {
// 	vec4 color = vec4(0.0);
// 	color += texture2D( source, texCoord.st + vec2( -3.0 * blurDirection.x, -3.0 * blurDirection.y ) )  *  0.015625;
// 	color += texture2D( source, texCoord.st + vec2( -2.0 * blurDirection.x, -2.0 * blurDirection.y ) ) * 0.09375;
// 	color += texture2D( source, texCoord.st + vec2( -1.0 * blurDirection.x, -1.0 * blurDirection.y ) ) * 0.234375;
// 	color += texture2D( source, texCoord.st + vec2( 0.0 , 0.0) ) * 0.3125;
// 	color += texture2D( source, texCoord.st + vec2( 1.0 * blurDirection.x,  1.0 * blurDirection.y ) ) * 0.234375;
// 	color += texture2D( source, texCoord.st + vec2( 2.0 * blurDirection.x,  2.0 * blurDirection.y ) ) * 0.09375;
// 	color += texture2D( source, texCoord.st + vec2( 3.0 * blurDirection.x, -3.0 * blurDirection.y ) )  *  0.015625;
